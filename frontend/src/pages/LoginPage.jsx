...
export default function LoginPage() {
  ...
  const from = redirect || location.state?.from?.pathname || '/dashboard'
  ...
  const inputBase =
    'w-full pl-9 pr-3.5 py-[11px] border rounded-xl text-[0.9rem] ' +
  ...
  const inputError =
    inputBase + 'border-red-400 ring-[3px] ring-red-100'
  ...
  return (
    <div className="animate-[slideUp_0.45s_cubic-bezier(0.22,1,0.36,1)_both]">
      ...
      {/* Heading */}
      <div className="mb-7">
        <h1 className="font-serif text-[2.05rem] font-normal text-white
         leading-[1.15] tracking-[-0.5px] mb-1.5">
          Sign in
        </h1>
        <p className="text-sm text-gray-500 font-normal">
          Welcome back. Let&rsquo;s get you in.
        </p>
      </div>
